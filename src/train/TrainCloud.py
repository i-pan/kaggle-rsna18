...
def train(fold, backbone, 
          ...
          steps=8000,
          epochs=8,
          snapshot_path=os.path.join(WDIR, "../../models/RetinaNet/output/cloud/fold{}_384"),
          image_min_side=384,
          image_max_side=768,
          annotations_folder=os.path.join(WDIR, "../../models/RetinaNet/annotations/cloud/fold{}_train_concat_annotations.csv"), 
          classes_file_path=os.path.join(WDIR, "../../models/RetinaNet/classes.csv"), 
          val_annotations=os.path.join(WDIR, "../../models/RetinaNet/annotations/cloud/fold{}_pos_valid_annotations.csv")): 
